...
Pour exporter une nouvelle version du kit, copier uniquement `AGENTS.md` et `.codex/` sans les données projet listées ci-dessus. Le projet cible repart alors avec des modèles vierges, sans fuite de contexte ni de données.
