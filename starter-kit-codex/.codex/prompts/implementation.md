...
Travaille par changements petits et ciblés. Couvre le comportement attendu et les erreurs significatives. Exécute lint, tests, build et contrôle sécurité configurés, relis le diff et mets à jour les documents affectés. Avant tout push, exécute `verify-before-push.sh` et bloque si un contrôle échoue.
