...
![Version du kit](https://img.shields.io/badge/version-1.1.6-blue.svg)
...
Le kit est actuellement en version `1.1.6`. Toute modification du kit doit mettre à jour ce README, le changelog et la version selon `VERSIONING.md`.
