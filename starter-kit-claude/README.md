...
![Version du kit](https://img.shields.io/badge/version-1.1.3-blue.svg)
...
Le kit est actuellement en version `1.1.3`. Toute modification du kit doit mettre à jour ce README, le changelog et la version selon `VERSIONING.md`.
