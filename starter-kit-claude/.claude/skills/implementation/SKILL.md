---
name: implementation
description: Implémente une tâche bornée avec tests ciblés, changements minimaux et preuves réelles.
---
...
Pour frontend, backend, infrastructure, documentation technique ou tests. Utiliser les commandes déclarées dans `.claude/project-profile.toml` lorsqu'elles sont renseignées.
