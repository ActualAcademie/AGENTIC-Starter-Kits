...
Applique `.claude/policies/EXECUTION-MODE-POLICY.md` et `.claude/policies/EXCEPTIONAL-REQUESTS.md`. Vérifie `Agent` et `Work locally` avant de démarrer une carte.
