...
Applique `.claude/policies/EXECUTION-MODE-POLICY.md` et `.claude/policies/EXCEPTIONAL-REQUESTS.md` et `.claude/policies/DOCUMENTATION-LANGUAGE-POLICY.md`. Vérifie `Agent` et `Work locally` avant de démarrer une carte.
